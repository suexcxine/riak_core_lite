...
handle_cast({health_check_result, Pid, R}, State) ->
    ...
    State2 = handle_check_msg({result, Pid, R},
                              Service,
                              State),
    {noreply, State2}.
...
health_fsm(Msg, Service,
    ...
    {Reply, NextState, Check2} = health_fsm(StateName,
                                            Msg,
                                            Service,
                                            Check),
...
health_fsm(checking, {result, Pid, Cause}, Service,
    ...
    #health_check{health_failures = HPFails,
        ...
        InCheck,
    {Reply, HPFails1} = handle_fsm_exit(Cause,
                                        HPFails,
                                        HPMaxFails),
