...
validate(CreateOrUpdate, Bucket, ExistingProps,
    ...
    CoreErrors = validate_core_props(CreateOrUpdate,
				     Bucket,
				     ExistingProps,
				     BucketProps),
...
validate(CreateOrUpdate, Bucket, ExistingProps,
    ...
    {BucketProps, Errors} =
	Validator:validate(CreateOrUpdate,
			   Bucket,
			   ExistingProps,
			   BucketProps0),
    validate(CreateOrUpdate,
...
validate_core_props(CreateOrUpdate, Bucket,
    ...
    lists:foldl(fun (Prop, Errors) ->
			case validate_core_prop(CreateOrUpdate,
						Bucket,
						ExistingProps,
						Prop)
			    of
...
append_defaults(Items) when is_list(Items) ->
    ...
    FixedDefaults = case riak_core:bucket_fixups() of
			[] -> NewDefaults;
			Fixups ->
			    riak_core_ring_manager:run_fixups(Fixups,
							      default,
							      NewDefaults)
		    end,
